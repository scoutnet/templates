...
{/strip}{$eintrag.kalender.id}	{$eintrag.kalender.name}	{$eintrag.id}	{$eintrag.kategorie}	{$eintrag.startdatum|date_format:"%Y-%m-%d"}	{$eintrag.startzeit|date_format:"%H:%M:00"}	{$eintrag.enddatum|date_format:"%Y-%m-%d"}	{$eintrag.endzeit|date_format:"%H:%M:00"}	{$eintrag.titel}	{$eintrag.URL}	{$eintrag.ort}	{if $eintrag.autor.vorname || $eintrag.autor.nachname}{$eintrag.autor.vorname} {$eintrag.autor.nachname}{else}{$eintrag.autor.nickname}{/if}	{$eintrag.verband}	{$eintrag.kalender.ebene}	{$eintrag.Description|replace:"\r\n":"\\n"}{strip}
{*
